...
router.get('/', authorize, getAllVideos); // Ejemplo de ruta GET para obtener todos los videos
...
router.post('/', authorize, uploadSingleVideo.single('video'), handleUploadVideoError, validateVideoData, createVideo); // Ruta POST con validación de datos de video
